...
Almost always performed using U-Net. For multi/hyper-spectral imagery, classical techniques may be used (e.g. k-means).
...
* Google Earth Engine and Microsoft Planetary Computer are democratising access to 'planetary scale' compute platforms
...
* Create your own annotation tool using [Bokeh Holoviews](https://examples.pyviz.org/ml_annotators/ml_annotators.html#ml-annotators-gallery-ml-annotators) or [tkinter](https://github.com/matpalm/bnn#labelling)
