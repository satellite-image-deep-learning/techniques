...
18.22. [DC-GANs](https://github.com/thepanacealab/DCGAN.git) -> [Paper](https://doi.org/10.1007/978-3-031-35641-4_11): DC-GANs use CNNs to learn hierarchical features and spatial information from input data, making them more effective than traditional GANs at generating high-quality images.
...
- _Logo created with_ [_Brandmark_](https://app.brandmark.io/v3/)
