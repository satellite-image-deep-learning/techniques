...
* If step functions are too limited or you want to write pipelines in python (rather than json used by step functions) checkout hosted [AWS managed Airflow](https://aws.amazon.com/managed-workflows-for-apache-airflow/) or host [Prefect](https://www.prefect.io/) on AWS (will require kubernetes experience to deploy). Read [Orchestrate XGBoost ML Pipelines with Amazon Managed Workflows for Apache Airflow](https://aws.amazon.com/blogs/machine-learning/orchestrate-xgboost-ml-pipelines-with-amazon-managed-workflows-for-apache-airflow/)
