...
* [Techniques](https://github.com/robmarkcole/satellite-image-deep-learning#techniques)
  ...
  * [Segmentation](https://github.com/robmarkcole/satellite-image-deep-learning#Segmentation)
    ...
    * [Vegitation & crop boundaries](https://github.com/robmarkcole/satellite-image-deep-learning#segmentation---vegitation--crop-boundaries)
...
* [vesselTracker](https://github.com/carlossantamarizq/vesselTracker) -> Project based on reduced model of Yolov5 architecture using Pytorch. Custom dataset based on SAR imagery provided by Sentinel-1 through Eart Engine API.
...
### Kaggle - DeepSat (SAT-4) land cover classification
